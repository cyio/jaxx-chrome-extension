...
(function (jaxx) {
    var TokenController = (function (_super) {
        ...
        // tokens load balance on restore history call;
            ...
            this.coinService.downloadBalances([address]).done(function (res) {
                if (res && res.length) {
                    ...
                    setTimeout(function () {
                        ...
                        jaxx.Registry.application$.trigger(jaxx.Registry.ON_ADDRESS_CHANGED, _this);
                    }, 1000);
                }
                if (callBack)
                    callBack();
        ...
        TokenController.prototype.getCurrentAddress = function () {
            var address = this.getCurrentBalance().id;
            return address;
        };
        ...
        TokenController.prototype.activate = function () {
            ...
            if (!timestamp) {
                this.restoreHistory(function (err, result) {
                    if (err)
                        return;
