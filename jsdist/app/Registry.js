...
///<reference path="../ethereum/ethereum-controller.ts"/>
///<reference path="jaxx-animations.ts"/>
...
var FlashBannerColor;
(function (FlashBannerColor) {
    FlashBannerColor[FlashBannerColor["SUCCESS"] = 'success'] = "SUCCESS";
    FlashBannerColor[FlashBannerColor["ERROR"] = 'error'] = "ERROR";
})(FlashBannerColor || (FlashBannerColor = {}));
var jaxx;
(function (jaxx) {
    var Registry = (function () {
        ...
        // to have access to any object over Registry all abject have to register at initialization time ;
        //  ;
        Registry.register = function (obj) {
            Registry.registry[obj.id] = obj;
        };
        // to inject any class object by id;
        Registry.getObject = function (id) {
    ...
    Registry.API_KEY = '';
    Registry.ADDRESS_BOOK_DELETE_ADDRESS = 'ADDRESS_BOOK_DELETE_ADDRESS';
    Registry.SHOW_ADDRESS_BOOK = 'SHOW_ADDRESS_BOOK';
    Registry.SHOW_ADDRESS_INPUT = 'SHOW_ADDRESS_INPUT';
    Registry.ON_APPLICATION_READY = 'ON_APPLICATION_READY';
    ...
    Registry.ON_RESTORE_HISTORY_OFFLINE = 'ON_RESTORE_HISTORY_OFFLINE';
    ...
    // coin controllers event bus
    Registry.CTR$ = $({});
    Registry.CTR_ERROR_NO_INTERNET_ON_RESTORE_HISTORY = 'CTR_ERROR_NO_INTERNET_ON_RESTORE_HISTORY';
    Registry.CTR_SERVICE_ERROR = 'CTR_SERVICE_ERROR';
    Registry.CTR_INITIALIZATION = 'CTR_INITIALIZATION';
    // network events bus
    Registry.NET$ = $({});
    Registry.NET_OFFLINE = 'NET_OFFLINE';
    Registry.NET_ONLINE = 'NET_ONLINE';
    // user interactions events bus
    Registry.USER$ = $({});
    Registry.USER_CLICK = 'USER_CLICK';
