...
(function (jaxx) {
    var Application = (function () {
        ...
        Application.prototype.init = function () {
            var _this = this;
            /// TODO create better way detecting when all modules loaded and initialized.
            // For now detecting application ready state by first coin activated;
            jaxx.Registry.application$.on(jaxx.Registry.ON_COIN_ACTIVATED, function () {
                if (!_this.isAppReady)
                    jaxx.Registry.application$.triggerHandler(jaxx.Registry.ON_APPLICATION_READY);
                _this.isAppReady = true;
            });
            jaxx.Registry.application$.on(jaxx.Registry.MODULE_REDY, function (evt, obj) {
                console.log(jaxx.Registry.MODULE_REDY + ' ' + (obj.id || obj.constructor.name));
            });
        ...
        Application.prototype.setWakeApTimer = function () {
            ...
            $(document).on('mousedown', function () {
                jaxx.Registry.USER$.triggerHandler(jaxx.Registry.USER_CLICK);
        ...
        Application.prototype.hideInitializeWallet = function () {
            // after restoring history show current address
            jaxx.AddressView.instance.setCurrentAddress();
