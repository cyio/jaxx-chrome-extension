        ...
        CoinsListSetup.prototype.init = function () {
            ...
            this.$list.each(function (item, list) {
                $(list).on('click', 'tr', function (evt) {
                    ...
                    if (element) {
                        element.toggleClass('cssCurrencyChecked');
                        jaxx.Registry.application$.triggerHandler(jaxx.Registry.ON_COIN_SATUS_CHANGED, [row.data('symbol'), element.hasClass('cssCurrencyChecked')]);
