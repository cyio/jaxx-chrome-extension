...
(function (jaxx) {
    ...
    var AddressView = (function () {
        ...
        AddressView.prototype.setCurrentAddress = function () {
            ...
            if (!ctr)
                return;
            //if restoring history show dashes otherwise current address
            if (ctr.isRestoringHistory && !ctr.isToken)
                address = '-----';
            else
    ...
    var Spinner = (function () {
        ...
        Spinner.prototype.animateInAllWalletElements = function (onDone) {
            ...
            if ($(document).width() > 1000 || PlatformUtils.mobileIpadCheck()) {
