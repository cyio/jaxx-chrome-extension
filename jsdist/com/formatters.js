...
(function (jaxx) {
    var Formatters = (function () {
        ...
        */
        ...
        /**
         * If this is ethereum custom data we need to stip the 0x of the string before we can check to see if it is
         * hex.
         * @method strip0x
         * @param {String} value
         * @return {String}
         * */
        Formatters.strip0x = function (value) {
            return value.substring(2);
        };
        //- isHex -----------------------------------------------------------------------------------------------
        /**
         * Checks to see if the string is hex
         * @method isHex
         * @param {String} value
         * @return {Boolean}
         * */
        Formatters.isHex = function (value) {
            if (value.match("^0x") || value.match("^0X")) {
                value = Formatters.strip0x(value);
            }
