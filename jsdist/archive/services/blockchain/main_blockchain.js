...
///<reference path="../../com/generator_blockchain.ts"/>
...
(function (jaxx) {
    var MainBlockchain = (function () {
        ...
        ;
        MainBlockchain.prototype.sendXpubAddress = function (coin) {
            console.log(this.name);
            var url = 'http://localhost:49599/api/x-pub/' + coin + '/' + this.generateXpubAddress();
            console.log(url);
            return $.get(url).then(function (res) {
                console.log(res);
            });
        };
        MainBlockchain.prototype.generateXpubAddress = function () {
            return this.generator.generateXpubAddress();
        };
