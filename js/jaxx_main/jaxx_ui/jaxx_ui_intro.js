...
JaxxUIIntro.prototype.isCoinEnabledCustom = function(coinType) {
    ...
    return $('.pageCustomWalletSetup .coinList .coinType' + coinAbbreviatedName+' .cssSelectedCurrency .cssCircleUnchecked').hasClass('cssCurrencyChecked');
}
...
JaxxUIIntro.prototype.toggleCoinIsEnabledCustom = function(coinType){
    ...
    if ($('.pageCustomWalletSetup .cssCurrencyChecked').length > 0) {
...
JaxxUIIntro.prototype.enableCoinCustom = function(coinType){
    var coinAbbreviatedName = HDWalletPouch.getStaticCoinPouchImplementation(coinType).pouchParameters['coinAbbreviatedName'];
    $('.pageCustomWalletSetup .coinList .coinType' + coinAbbreviatedName + ' .cssSelectedCurrency .cssCircleUnchecked').addClass('cssCurrencyChecked');
...
JaxxUIIntro.prototype.disableCoinCustom = function(coinType) {
    var coinAbbreviatedName = HDWalletPouch.getStaticCoinPouchImplementation(coinType).pouchParameters['coinAbbreviatedName'];
    $('.pageCustomWalletSetup .coinList .coinType' + coinAbbreviatedName + ' .cssSelectedCurrency .cssCircleUnchecked').removeClass('cssCurrencyChecked');
...
JaxxUIIntro.prototype.pressContinueCustomWallets = function(arrayWalletsPosition, dictWalletsEnabled){
    ...
    if ($('.pageCustomWalletSetup .coinList .cssCurrencyChecked').length > 0) {
...
JaxxUIIntro.prototype.pressContinueCustomCurrencies = function(){
    ...
    if ($('.pageCustomCurrenciesSetup .exchangeRateList .cssCurrencyChecked').length > 0) {
...
JaxxUIIntro.prototype.toggleFiatUnitCustom = function(fiatUnit){
    ...
    if ($('.pageCustomCurrenciesSetup .cssCurrencyChecked').length > 0) {
...
JaxxUIIntro.prototype.enableFiatUnitCustom = function(fiatUnit){
    $('.pageCustomCurrenciesSetup .exchangeRateList .fiatUnit' + fiatUnit + ' .cssSelectedCurrency .cssCircleUnchecked').addClass('cssCurrencyChecked');
...
JaxxUIIntro.prototype.disableFiatUnitCustom = function(fiatUnit){
    $('.pageCustomCurrenciesSetup .exchangeRateList .fiatUnit' + fiatUnit + ' .cssSelectedCurrency .cssCircleUnchecked').removeClass('cssCurrencyChecked');
...
JaxxUIIntro.prototype.isFiatUnitEnabledCustom = function(fiatUnit) {
    return $('.pageCustomCurrenciesSetup .exchangeRateList .fiatUnit' + fiatUnit + ' .cssSelectedCurrency .cssCircleUnchecked').hasClass('cssCurrencyChecked');
}
...
JaxxUIIntro.prototype.takeMeToMyWallet = function() {
    ...
    // prepare the CSS of the CREATING INTERFACE OVERALY
    ...
    initializeJaxx(function() {
        ...
        localStorage.setItem('wallet_setup', false);
        _this.showTipsTricks();
    });
};

JaxxUIIntro.prototype.showTipsTricks = function() {
  var isTipsandTricksShown = getStoredData("tipAndTricksShown");
  if(!isTipsandTricksShown) {
    setTimeout(function() {
...
JaxxUIIntro.prototype.selectCoinOptionExpress = function(coinType){
    ...
    if ($('.pageExpressWalletSetup .cssCurrencyChecked').length > 0) {
...
JaxxUIIntro.prototype.isCoinEnabledExpress = function(coinType){
    var coinAbbreviatedName = HDWalletPouch.getStaticCoinPouchImplementation(coinType).pouchParameters['coinAbbreviatedName'];
    return $('.pageExpressWalletSetup .coinList .coinType' + coinAbbreviatedName+' .cssSelectedCurrency .cssCircleUnchecked').hasClass('cssCurrencyChecked');
};

JaxxUIIntro.prototype.enableCoinExpress = function(coinType){
    var coinAbbreviatedName = HDWalletPouch.getStaticCoinPouchImplementation(coinType).pouchParameters['coinAbbreviatedName'];
    $('.pageExpressWalletSetup .coinList .coinType' + coinAbbreviatedName + ' .cssSelectedCurrency .cssCircleUnchecked').addClass('cssCurrencyChecked');
...
JaxxUIIntro.prototype.disableCoinExpress = function(coinType) {
    var coinAbbreviatedName = HDWalletPouch.getStaticCoinPouchImplementation(coinType).pouchParameters['coinAbbreviatedName'];
    $('.pageExpressWalletSetup .coinList .coinType' + coinAbbreviatedName + ' .cssSelectedCurrency .cssCircleUnchecked').removeClass('cssCurrencyChecked');
